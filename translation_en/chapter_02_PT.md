...
> **DICA:** Mais informações sobre estratégias e práticas sobre como migrar um monolito existente para a arquitetura de microsserviços podem ser encontradas no capítulo [Microsserviços] () #TODO na fase de revisão: adicionar referência a https://github.com/otaviojava/manual-arquiteto-moderno/blob/master/chapter_05.md
...
> **DICA:** O capítulo [Cloud] () sobre Canary Releases, bem como sobre outras estratégias de implantação. #TODO na fase de revisão: adicione referência a https://github.com/otaviojava/manual-arquiteto-moderno/blob/master/chapter_07.md
